...
public class Boundary {
    ...
    public void pickedUpItem(String name) {
        String output = "You have picked up " + name
                + "\n***********************************************************************************";
        System.out.println(output);
    }

    public void droppedItem(String name) {
        String output = "You dropped " + name
                + "\n***********************************************************************************";
        System.out.println(output);
    }
    ...
    public void ErrorTextWriteHighScore(Exception ex) {
        //Logger.getLogger(Controller.class.getName()).log(Level.SEVERE, null, ex);
        System.out.println("Highscore.java: writeToHighscoreDocument: " + ex);
    }

    public void ErrorTextInfoFromHighScore(Exception ex) {
        //Logger.getLogger(Controller.class.getName()).log(Level.SEVERE, null, ex);
